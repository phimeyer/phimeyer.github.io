---
title: "Wordscores mit `quanteda`" 
author: "Philipp Meyer, Institut für Politikwissenschaft"
date: "09.06.2021, Wordscores mit `quanteda` (offizielles Quanteda-Tutorial in Englisch), Seminar: Quantitative Textanalyse"
output:
  html_document:
    toc: true
    toc_depth: 4
...
Dieses Tutorial soll euch die Wordscores-Methode näherbringen. Hierbei handelt es sich, ähnlich wie bei Naïve Bayse um eine supervised classification. Wordscores wurde maßgeblich von Ken Benoit entwickelt und vor allem auch in `quanteda` implementiert. Aus diesem Grund werde ich hier das offizielle Tutorial von der `quanteda` bereitstellen. Die Originalquelle findet ihr [hier](https://tutorials.quanteda.io/machine-learning/wordscores/).
