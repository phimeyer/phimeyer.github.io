...
Ähnlich wie bei Wordscore hat sich vor allem das `quanteda`-Team darum bemüht, eine sehr gute Implementierung der Wordfish-Methode zu realisieren. Aus diesem Grund werde ich hier das offizielle Tutorial von der `quanteda` bereitstellen. Die Originalquelle findet ihr [hier](https://tutorials.quanteda.io/machine-learning/wordfish/).
